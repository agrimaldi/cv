...
\address{25 rue Monge}{75005 Paris}    % optional, remove the line if not wanted
\mobile{+33 7 86 10 78 17}                     % optional, remove the line if not wanted
% \phone{+2~(345)~678~901}                      % optional, remove the line if not wanted
% \fax{+3~(456)~789~012}                        % optional, remove the line if not wanted
\email{alexis.grimaldi@gmail.com}                          % optional, remove the line if not wanted
